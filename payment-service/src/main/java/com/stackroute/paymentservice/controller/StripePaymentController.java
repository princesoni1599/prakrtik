...
//    }
    ...
    @GetMapping("/{price}/{productName}/{productId}")
    public String homepage(@PathVariable String price, @PathVariable String productName, @PathVariable String productId ) {
...
//    }
    ...
    @PostMapping("/create-charge")
        ...
        String chargeId = stripeService.createCharge(email, token);// 9.99 usd
